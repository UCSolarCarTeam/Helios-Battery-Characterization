...
def main(): # Main function of script
    ...
    print(voltage_current_table('01-01-01', 'Cycle_Test_Carton_15b.csv')) # Outputs the processed data for the specfic cell from a CSV
...
def voltage_current_table(cell_number:str, csv_filename:str):
    ...
    """ 
    with open(csv_filename, 'a+') as opened_csv:
